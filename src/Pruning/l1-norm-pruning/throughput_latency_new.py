...
test_loader = data.DataLoader(testset, batch_size=args.test_batch_size, sampler=rand_sampler, shuffle=False)
...
def test(test_loader, max=5, warmup=0, iterations=1):
    model.eval()
    correct = 0
    #Warmup
