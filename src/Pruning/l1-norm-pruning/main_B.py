...
parser.add_argument('--dataloc', default='../data', type=str, metavar='PATH',
...
def test():
    ...
    for data, target in test_loader:
        if args.cuda:
            data, target = data.cuda(), target.cuda()
        ## should replace volatile with no_grad as it is deprecated in python3.7    
        ## link: https://discuss.pytorch.org/t/volatile-now-has-no-effect-use-with-torch-no-grad-instead/26656/17
