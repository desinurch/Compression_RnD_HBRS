...
# various path
parser.add_argument('--save_root', type=str, default='./logs', help='models and logs are saved here')
...
def main():
	...
	if not os.path.exists(os.path.join(args.save_root,'checkpoint_fitnet')):
		os.makedirs(os.path.join(args.save_root,'checkpoint_fitnet'))
	...
	load_pretrained_model(snet, checkpoint['state_dict'])
	...
	for epoch in range(1, args.epochs+1):
		...
		# save model
		print('saving models......')
		save_name = 'fitnet_r{}_r{}_{:>03}.pth.tar'.format(args.t_name[6:], args.s_name[6:], epoch)
